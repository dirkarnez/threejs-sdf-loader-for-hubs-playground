...
const BONDS_LINES = 0;
const BONDS_CYLINDERS = 1;

//MoleculeGeometryBuilder.ATOMS_CIRCLES = 0;
const ATOMS_SPHERES = 1;

import * as THREE from 'three';
import * as BufferGeometryUtils from 'three/addons/utils/BufferGeometryUtils.js';

export class MoleculeGeometryBuilder {
    create(json, atomRenderType, bondRenderType, atomScale, bondThickness) {
        if (json.ok === false)
